...
public class TableColumn extends BaseEntity {
    ...
    @TableField(value = "java_name", el = "javaName")
    ...
    @TableField(value = "database_type", el = "databaseType")
    ...
    @TableField(value = "jdbc_type", el = "jdbcType")
    ...
    @TableField(value = "java_type", el = "javaType")
    ...
    @TableField(value = "table_info_id", el = "tableInfoId")
